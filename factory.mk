...
FACTORY_PATH := device/khadas/vim3/factory
...
else ifneq ("$(wildcard vendor/amlogic/vim3/radio/bootloader-recovery.img)","")
	$(hide) $(call aml-copy-install-file, vendor/amlogic/vim3/radio/bootloader-recovery.img, u-boot.bin)
else
...
else ifneq ("$(wildcard vendor/amlogic/vim3/radio/bootloader.img)","")
	$(hide) $(call aml-copy-upgrade-file, vendor/amlogic/vim3/radio/bootloader.img, u-boot.bin)
else
	$(error "no u-boot.bin found in $(FACTORY_PATH)")
endif
